    ...
    const row = new MessageActionRow()
      .addComponents(
        new MessageButton()
          .setLabel("Pause")
          .setCustomId("pause")
          .setEmoji("<:Pausechill:984839907618984046>")
          .setStyle("SUCCESS")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Replay")
          .setCustomId("replay")
          .setEmoji("<:IconReplay:984837281007423489>")
          .setStyle("PRIMARY")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Stop")
          .setCustomId("stop")
          .setEmoji("<:stopchill:984839547231809646>")
          .setStyle("DANGER")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Skip")
          .setCustomId("skip")
          .setEmoji("<:arrow:984401901644820530>")
          .setStyle("PRIMARY")
      )
      .addComponents(
        new MessageButton()
          .setLabel("loop")
          .setCustomId("loop")
          .setEmoji("<:loopchill:984838747214471188>")
          .setStyle("SUCCESS")
      )
    ...
    const row2 = new MessageActionRow()
      .addComponents(
        new MessageButton()
          .setLabel("Shuffle")
          .setCustomId("shuffle")
          .setEmoji("<:Shuffle:984838218602135592>")
          .setStyle("SUCCESS")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Down")
          .setCustomId("voldown")
          .setEmoji("<:voldown:984840327775015012>")
          .setStyle("PRIMARY")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Clear")
          .setCustomId("clear")
          .setEmoji("<:ClearMessages:984837279199670303>")
          .setStyle("DANGER")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Up")
          .setCustomId("volup")
          .setEmoji("<:volume_rubby:984406014067609610>")
          .setStyle("PRIMARY")
      )
      .addComponents(
        new MessageButton()
          .setLabel("Queue")
          .setCustomId("queue")
          .setEmoji("<:queue:984413985220726844>")
          .setStyle("SUCCESS")
      )
      ...
      .addComponents(
        new MessageButton()
            ...
            .setStyle("LINK")
            .setURL(`https://discord.gg/ZgQSXqQw6p`)
    )
   
    const nplaying = await client.channels.cache.get(player.textChannel).send({ embeds: [embeded], components: [row, row2, row3] });
